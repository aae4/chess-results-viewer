...
на странице туров проваливаюсь в партию, жму назад, номер тура сбрасывается

======

на главной нет скелетона

=======

БАГ: на глобальном профиле игрока раздел Результативность не учитывает ничьи в количестве партий.

БАГ: на главной странице если последний турнир уже прошел, все равно показывается LIVE иконка

БАГ: в кросс-таблице никак не отражается техническое поражение и bye

БАГ: на странице игрока в рамках турнира, если результат bye, не отображается в списке
