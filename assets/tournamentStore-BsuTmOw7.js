import{D as $,r as D,c as Y}from"./index-BZw3c7fe.js";var q={exports:{}},U=q.exports,z;function X(){return z||(z=1,(function(o,w){(function(v,P){o.exports=P()})(U,(function(){return(()=>{var v={870:(d,u,i)=>{i.r(u),i.d(u,{createEndpoint:()=>M,expose:()=>J,proxy:()=>p,proxyMarker:()=>A,releaseProxy:()=>h,transfer:()=>S,transferHandlers:()=>_,windowEndpoint:()=>O,wrap:()=>t});const A=Symbol("Comlink.proxy"),M=Symbol("Comlink.endpoint"),h=Symbol("Comlink.releaseProxy"),m=Symbol("Comlink.thrown"),g=e=>typeof e=="object"&&e!==null||typeof e=="function",_=new Map([["proxy",{canHandle:e=>g(e)&&e[A],serialize(e){const{port1:n,port2:f}=new MessageChannel;return J(e,n),[f,[f]]},deserialize:e=>(e.start(),t(e))}],["throw",{canHandle:e=>g(e)&&m in e,serialize({value:e}){let n;return n=e instanceof Error?{isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:{isError:!1,value:e},[n,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}}]]);function J(e,n=self){n.addEventListener("message",(function f(c){if(!c||!c.data)return;const{id:C,type:W,path:b}=Object.assign({path:[]},c.data),L=(c.data.argumentList||[]).map(y);let E;try{const T=b.slice(0,-1).reduce(((I,G)=>I[G]),e),j=b.reduce(((I,G)=>I[G]),e);switch(W){case 0:E=j;break;case 1:T[b.slice(-1)[0]]=y(c.data.value),E=!0;break;case 2:E=j.apply(T,L);break;case 3:E=p(new j(...L));break;case 4:{const{port1:I,port2:G}=new MessageChannel;J(e,G),E=S(I,[I])}break;case 5:E=void 0}}catch(T){E={value:T,[m]:0}}Promise.resolve(E).catch((T=>({value:T,[m]:0}))).then((T=>{const[j,I]=k(T);n.postMessage(Object.assign(Object.assign({},j),{id:C}),I),W===5&&(n.removeEventListener("message",f),F(n))}))})),n.start&&n.start()}function F(e){(function(n){return n.constructor.name==="MessagePort"})(e)&&e.close()}function t(e,n){return s(e,[],n)}function a(e){if(e)throw new Error("Proxy has been released and is not useable")}function s(e,n=[],f=function(){}){let c=!1;const C=new Proxy(f,{get(W,b){if(a(c),b===h)return()=>N(e,{type:5,path:n.map((L=>L.toString()))}).then((()=>{F(e),c=!0}));if(b==="then"){if(n.length===0)return{then:()=>C};const L=N(e,{type:0,path:n.map((E=>E.toString()))}).then(y);return L.then.bind(L)}return s(e,[...n,b])},set(W,b,L){a(c);const[E,T]=k(L);return N(e,{type:1,path:[...n,b].map((j=>j.toString())),value:E},T).then(y)},apply(W,b,L){a(c);const E=n[n.length-1];if(E===M)return N(e,{type:4}).then(y);if(E==="bind")return s(e,n.slice(0,-1));const[T,j]=r(L);return N(e,{type:2,path:n.map((I=>I.toString())),argumentList:T},j).then(y)},construct(W,b){a(c);const[L,E]=r(b);return N(e,{type:3,path:n.map((T=>T.toString())),argumentList:L},E).then(y)}});return C}function r(e){const n=e.map(k);return[n.map((c=>c[0])),(f=n.map((c=>c[1])),Array.prototype.concat.apply([],f))];var f}const l=new WeakMap;function S(e,n){return l.set(e,n),e}function p(e){return Object.assign(e,{[A]:!0})}function O(e,n=self,f="*"){return{postMessage:(c,C)=>e.postMessage(c,f,C),addEventListener:n.addEventListener.bind(n),removeEventListener:n.removeEventListener.bind(n)}}function k(e){for(const[n,f]of _)if(f.canHandle(e)){const[c,C]=f.serialize(e);return[{type:3,name:n,value:c},C]}return[{type:0,value:e},l.get(e)||[]]}function y(e){switch(e.type){case 3:return _.get(e.name).deserialize(e.value);case 0:return e.value}}function N(e,n,f){return new Promise((c=>{const C=new Array(4).fill(0).map((()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16))).join("-");e.addEventListener("message",(function W(b){b.data&&b.data.id&&b.data.id===C&&(e.removeEventListener("message",W),c(b.data))})),e.start&&e.start(),e.postMessage(Object.assign({id:C},n),f)}))}},162:function(d,u,i){var A=this&&this.__createBinding||(Object.create?function(t,a,s,r){r===void 0&&(r=s),Object.defineProperty(t,r,{enumerable:!0,get:function(){return a[s]}})}:function(t,a,s,r){r===void 0&&(r=s),t[r]=a[s]}),M=this&&this.__setModuleDefault||(Object.create?function(t,a){Object.defineProperty(t,"default",{enumerable:!0,value:a})}:function(t,a){t.default=a}),h=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var a={};if(t!=null)for(var s in t)s!=="default"&&Object.prototype.hasOwnProperty.call(t,s)&&A(a,t,s);return M(a,t),a};Object.defineProperty(u,"__esModule",{value:!0}),u.createDbWorker=void 0;const m=h(i(870));async function g(t){if(t.data&&t.data.action==="eval"){const a=new Int32Array(t.data.notify,0,2),s=new Uint8Array(t.data.notify,8);let r;try{r={ok:await F(t.data.request)}}catch(S){console.error("worker request error",t.data.request,S),r={err:String(S)}}const l=new TextEncoder().encode(JSON.stringify(r));s.set(l,0),a[1]=l.length,Atomics.notify(a,0)}}function _(t){if(t.tagName==="BODY")return"body";const a=[];for(;t.parentElement&&t.tagName!=="BODY";){if(t.id){a.unshift("#"+t.id);break}{let s=1,r=t;for(;r.previousElementSibling;)r=r.previousElementSibling,s++;a.unshift(t.tagName.toLowerCase()+":nth-child("+s+")")}t=t.parentElement}return a.join(" > ")}function J(t){return Object.keys(t)}async function F(t){if(console.log("dom vtable request",t),t.type==="select")return[...document.querySelectorAll(t.selector)].map((a=>{const s={};for(const r of t.columns)r==="selector"?s.selector=_(a):r==="parent"?a.parentElement&&(s.parent=a.parentElement?_(a.parentElement):null):r==="idx"||(s[r]=a[r]);return s}));if(t.type==="insert"){if(!t.value.parent)throw Error('"parent" column must be set when inserting');const a=document.querySelectorAll(t.value.parent);if(a.length===0)throw Error(`Parent element ${t.value.parent} could not be found`);if(a.length>1)throw Error(`Parent element ${t.value.parent} ambiguous (${a.length} results)`);const s=a[0];if(!t.value.tagName)throw Error("tagName must be set for inserting");const r=document.createElement(t.value.tagName);for(const l of J(t.value))if(t.value[l]!==null){if(l==="tagName"||l==="parent")continue;if(l==="idx"||l==="selector")throw Error(`${l} can't be set`);r[l]=t.value[l]}return s.appendChild(r),null}if(t.type==="update"){const a=document.querySelector(t.value.selector);if(!a)throw Error(`Element ${t.value.selector} not found!`);const s=[];for(const r of J(t.value)){const l=t.value[r];if(r!=="parent"){if(r!=="idx"&&r!=="selector"&&l!==a[r]){if(console.log("SETTING ",r,a[r],"->",l),r==="tagName")throw Error("can't change tagName");s.push(r)}}else if(l!==_(a.parentElement)){const S=document.querySelectorAll(l);if(S.length!==1)throw Error(`Invalid target parent: found ${S.length} matches`);S[0].appendChild(a)}}for(const r of s)a[r]=t.value[r];return null}throw Error(`unknown request ${t.type}`)}m.transferHandlers.set("WORKERSQLPROXIES",{canHandle:t=>!1,serialize(t){throw Error("no")},deserialize:t=>(t.start(),m.wrap(t))}),u.createDbWorker=async function(t,a,s,r=1/0){const l=new Worker(a),S=m.wrap(l),p=await S.SplitFileHttpDatabase(s,t,void 0,r);return l.addEventListener("message",g),{db:p,worker:S,configs:t}}},432:function(d,u,i){var A=this&&this.__createBinding||(Object.create?function(h,m,g,_){_===void 0&&(_=g),Object.defineProperty(h,_,{enumerable:!0,get:function(){return m[g]}})}:function(h,m,g,_){_===void 0&&(_=g),h[_]=m[g]}),M=this&&this.__exportStar||function(h,m){for(var g in h)g==="default"||Object.prototype.hasOwnProperty.call(m,g)||A(m,h,g)};Object.defineProperty(u,"__esModule",{value:!0}),M(i(162),u)}},P={};function R(d){var u=P[d];if(u!==void 0)return u.exports;var i=P[d]={exports:{}};return v[d].call(i.exports,i,i.exports,R),i.exports}return R.d=(d,u)=>{for(var i in u)R.o(u,i)&&!R.o(d,i)&&Object.defineProperty(d,i,{enumerable:!0,get:u[i]})},R.o=(d,u)=>Object.prototype.hasOwnProperty.call(d,u),R.r=d=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(d,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(d,"__esModule",{value:!0})},R(432)})()}))})(q)),q.exports}var K=X();const Q=new URL("/chess-results-viewer/assets/sqlite.worker-DMS32ee_.js",import.meta.url),V=new URL("/chess-results-viewer/assets/sql-wasm-Bv7gRpUo.wasm",import.meta.url),Z=location.hostname.endsWith("github.io"),ee=Z?"https://raw.githubusercontent.com/aae4/chess-results-viewer/multitournament_with_db/public/database.sqlite":"/chess-results-viewer/database.sqlite";async function te(){const o=await K.createDbWorker([{from:"inline",config:{serverMode:"full",url:ee,requestChunkSize:4096,databaseLengthBytes:5652480}}],Q.toString(),V.toString());return o.db.query("PRAGMA cache_size=-2048; PRAGMA temp_store=MEMORY;"),o.db}let B=null;const ae=()=>(B||(B=te()),B);async function x(o,w=[]){const v=await ae(),P=[];for(const R of await v.query(o,w))P.push(R);return P}const H={getAllTournaments:()=>x(`
  ...
  `,[o]),getGamesForStatistics:o=>x(`
    ...
    JOIN players bp ON bp.id = bpf.player_id
    WHERE g.tournament_id = ?
  `,[o])},ne=$("tournaments",()=>{const o=D([]),w=D(!1),v=D(null),P=D(null),R=D([]),d=D([]),u=D([]),i=D(!1),A=D(null),M=D([]),h=D(null),m=D([]),g=D([]),_=D(null),J=Y(()=>w.value||i.value);async function F(){w.value=!0,v.value=null;try{o.value.length===0&&(o.value=await H.getAllTournaments())}catch(p){v.value=p.message}finally{w.value=!1}}function t(p){const O={},k=p.split(`
`);for(let y=1;y<k.length;y++){const N=k[y].trim();if(!N)continue;const e=N.split("	");if(e.length<3)continue;const[n,f,c]=e;O[c]={e:n,n:f}}return O}async function a(){try{const O=["a.tsv","b.tsv","c.tsv","d.tsv","e.tsv"].map(N=>fetch(`data/${N}`).then(e=>e.text())),y=(await Promise.all(O)).map(N=>t(N));return Object.assign({},...y)}catch(p){return console.error("Error loading ECO database:",p),null}}async function s(p){if(P.value?.id!==parseInt(p)){i.value=!0,v.value=null;try{const[O,k,y,N,e,n,f]=await Promise.all([H.getTournamentDetails(p),H.getTournamentStandings(p),H.getTournamentGames(p),H.getTournamentParticipants(p),H.getDataForCrosstable(p),H.getGamesForStatistics(p),a()]);P.value=O,R.value=k,d.value=y,u.value=N,m.value=e,g.value=n,_.value=f}catch(O){v.value=O.message}finally{i.value=!1}}}async function r(p,O){i.value=!0,v.value=null;try{const[k,y]=await Promise.all([H.getPlayerProfileInTournament(p,O),H.getPlayerGamesInTournament(p,O)]);A.value=k,M.value=y}catch(k){v.value=k.message}finally{i.value=!1}}async function l(p){i.value=!0,v.value=null;try{h.value=await H.getGameDetails(p)}catch(O){v.value=O.message}finally{i.value=!1}}function S(){P.value=null,R.value=[],d.value=[],u.value=[],A.value=null,M.value=[],h.value=null,m.value=[],g.value=[]}return{tournamentsList:o,activeTournament:P,standings:R,games:d,participants:u,activePlayer:A,activePlayerGames:M,activeGame:h,error:v,isLoading:J,isLoadingList:w,isLoadingDetails:i,fetchAllTournaments:F,fetchTournamentData:s,fetchPlayerData:r,fetchGameData:l,crosstableData:m,statisticsData:g,ecoDatabase:_,clearActiveData:S}});export{ne as u};
